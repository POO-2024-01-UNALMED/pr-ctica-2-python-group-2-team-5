...
class Hospital:
    ...
    def deserializar(self):
        deserealizarDoctores = open("../../base_datos/temp/registro_doctores.pickle", "rb")
        self.listaDoctores = pickle.load(deserealizarDoctores)
        deserealizarDoctores.close()
        deserealizarPacientes = open("../../base_datos/temp/registro_pacientes.pickle", "rb")
        self.listaPacientes = pickle.load(deserealizarPacientes)
        deserealizarPacientes.close()
        deserealizarMedicamentos =  open("../../base_datos/temp/registro_medicamentos.pickle", "rb")
        self.listaMedicamentos = pickle.load(deserealizarMedicamentos)
        deserealizarMedicamentos.close()
        deserealizarVacunas = open("../../base_datos/temp/registro_vacunas.pickle", "rb")
        self.listaVacunas = pickle.load(deserealizarVacunas)
        deserealizarVacunas.close()
        deserealizarEnfermedades =  open("../../base_datos/temp/registro_enfermedades.pickle", "rb")
        Enfermedad.enfermedadesRegistradas = pickle.load(deserealizarEnfermedades)
        deserealizarEnfermedades.close()
        deserealizarHabitaciones = open("../../base_datos/temp/registro_habitaciones.pickle", "rb")
        self.habitaciones = pickle.load(deserealizarHabitaciones)
        deserealizarHabitaciones.close()
